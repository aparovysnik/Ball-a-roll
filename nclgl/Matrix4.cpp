...
Matrix4 Matrix4::Rotation(Vector4 quat)
{
	quat.Normalise();

	float elements[16] = { 1.0f - 2.0f*quat.y*quat.y - 2.0f*quat.z*quat.z, 2.0f*quat.x*quat.y - 2.0f*quat.z*quat.w, 2.0f*quat.x*quat.z + 2.0f*quat.y*quat.w, 0.0f,
